...
function Signup() {
    ...
    const handleSignup = async () => {
        const user = {
          ...
          await axios.post("https://flightbooking-ka.herokuapp.com/api/signup", user).then(function (response) {
          if(response.data)
          {
    ...
    return (
        <div>
            <Bar />
        <div>
        <div className="min-w-screen min-h-screen bg-sky-600 flex items-center justify-center px-5 py-5">
                        ...
                        <div>
                            ...
                            <div className="flex -mx-3">
                                <div className="w-full px-3 mb-5">
                                    <button onClick={ ()=>{
                                        handleSignup();
                                    }} className="block w-full max-w-xs mx-auto bg-yellow-400 hover:bg-yellow-500 focus:bg-yellow-500 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                                </div>
                            </div>
                        </div>
                    </div>
